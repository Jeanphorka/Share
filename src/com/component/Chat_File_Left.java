...
public class Chat_File_Left extends javax.swing.JPanel {

   
    public Chat_File_Left() {
        initComponents();
        setOpaque(false);
    }
    
    public void setFileleft(String fileName, String size){

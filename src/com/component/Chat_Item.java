...
//        cmd.setForeground(new Color(43, 91, 175));
//        cmd.setFont(new java.awt.Font("Leelawadee UI", 1, 13));
...
//    }
    ...
    public void setFileleft(String fileName, String fileSize) {
        ...
        layer.setLayout(new FlowLayout(FlowLayout.RIGHT));
        layer.setBorder(new EmptyBorder(0, 5, 0, 5));
        Chat_File_Left chatFile = new Chat_File_Left();
        chatFile.setFileleft(fileName, fileSize);
        layer.add(chatFile);
        add(layer);
    }
    ...
    public void setEmoji(boolean right, Icon icon) {
        ...
        add(layer);
        setBackground(new Color(244, 238, 255));
    }

    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/icon/check.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/icon/double_check.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt.setBorder(javax.swing.BorderFactory.createEmptyBorder(10, 10, 5, 10));
        txt.setFont(new java.awt.Font("Mitr Light", 0, 12)); // NOI18N
